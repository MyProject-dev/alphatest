...
$li = $article->getData($_GET['id']);
$_SESSION['plno']    = $_GET['id'];
$date_               = $li[0]['date_'];
$lookOwnerMno        = intval($li[0]["mno"]);
$mno1                = intval($li[0]["mno"]);
...
// $_SESSION['details_user_mno'] = $mno;
            ...
            #USER OWNER MODAL 
                ...
                $user1['username']                           =  $mc->get_username_by_mno($modal['mno']);  //$user1['user']['username'];
...
<head>
    ...
    <title><?php print(strip_tags($modal['title'])); ?></title>
                ...
                <table class="details-page-header-table-1" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td class="padding-bottom padding-top border-bottom header-category" id="imgV">
                            <div class="center">
                                <a href="article?category=<?php  echo strtolower($modal['category']); ?>&topic=<?php echo strtolower($modal['topic']) ?>">
                                                ...
                                                <center>
                                                    <div id="load_look_picture_and_tags"  >
                                                       ...
                                                       ?>
                                                        ...
                                                        <?php $article_modal_style = 'margin-top: -63px;width:889px'; ?>
                                                            ...
                                                            <?php  $modal['view_footer_id']  = 'lf_div_container'; ?>
                                                        <?php  else: ?>  
                                            ...
                                            <tr>
                                                <td>   
                                                    <div class="profile-follow center padding-profile-top blue border-top" >   
                                                        <?php $mc->print_user_modals_follow_or_unfollow_buttons($mno,  $mno1, 'width:103px !important', 'fs_folders/images/profile/follow.png', 'fs_folders/images/profile/following.png', 'details', '#details-follow-counter');  ?> 
                                                       <!--  
                                                            <img 
