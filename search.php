							...
							<tr> 
				 			...
				 			<tr>
								<td>   
										...
										<div style="color:black;  margin-top:20px;/* border:1px solid red; */padding-left: 300px;padding-top: 61px;height: 400px;" >
							 		 		<br><br><br> 
							 		 		<h1> Searching member, item, style and more.. are comming soon! </h1> 
							 		 		<a href="home">Home</a>
							 		 	</div>
