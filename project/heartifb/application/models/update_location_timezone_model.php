<?php
	...
	class Update_location_timezone_model extends CI_Model {
		...
		*/
		...
		function run_update($limit=50,$offset=0)
		{
			$this->limit = $limit;
			$this->offset = $offset;
		...
		{  
			...
			echo   'limit ' . $this->limit . ', ' . $this->offset . " total result " . $query->num_rows() . '<br>';
