...
class LookBookExted  extends LookbookDataBase 
{
	...
	{   
		...
		{ 
		    ...
		    break;
		    case 'BANGKOK':
		        $timezone='http://www.timeanddate.com/worldclock/thailand/bangkok';
		        $url='ICT';
		  	break;
		    case 'TAIPEI':
		        $timezone='http://www.timeanddate.com/worldclock/taiwan/taipei';
		        $url='CST';
		    break;
		    case 'PARIS':
		...
		//echo "<br> timezone $timezone location $location ";
		return $timezone;  
	}
	...
	{ 
        ...
        $this->profileUrlLookTabHyped = $lookBookDomain .''. $username; //$this->profileUrlLookTabHyped = $lookBookDomain .''. $username . '/' . $profileLookTabHyped;
		$this->profileUrlCommentTab = $lookBookDomain .''. $username . '/' . $profileTabComment;


       // echo " profile url look tab " . $this->profileUrlLookTab . "<br>";
      //  echo " profile url hype tab " . $this->profileUrlLookTabHyped . "<br>";
       // echo " profile url comment tab " . $this->profileUrlCommentTab . "<br>";
	...
	{ 
        ...
        //*[@id="results"]/li[1]/table/tbody/tr/td[1]/a
		...
		{    
		    $username1 = $u->getAttribute("data-href"); 
...
//*[@id="results"]/li[1]/table/tbody/tr/td[1]/a
/*
        $usernames = $xpath->query("//*[@class='image']");
        $c = 0;
        foreach($usernames as $u)
        {
            $username[$c] = $u->getAttribute("href");
            $c++;
        }
        $this->usernames = $username;
...
*/
	...
	public function getUserInformation1()
	{  


		return $this->userInformation1; 
	}
