...
<center>
	<div style="width:1024px;margin:0 auto;">
		...
		<br><br>
		<center>
			<table style="width:900px;height:255px;border-collapse:collapse;" border="0"  >
				<td width=49.5% style="padding:2px 5px 15px 70px;background:url('images 1/arrow-left.png') left center no-repeat;border:1px solid none;"  > 
					<?php
						if($b=="ch")
							echo '<span style="font:30px misoLight;">SOMETHING COOL IS COMING<br>TO FASHION LOVERS!</span>';
						else
							echo '<span style="font:20px helvetica;">SOMETHING COOL IS COMING<br>TO FASHION LOVERS!</span>';
					?>
					<div style="padding:5px"></div>
					<b style="font-family:misoBold;font-size:20px">exposure. descover. learning. rewards</b>
					<div style="padding:5px"></div>
					...
					your voice is heard, and your participation is rewarded.
 					...
 					FASHION SPONGE IS THE EASIEST AND FASTEST WAY TO...
					Show your ootd, see the latest fashion trends, discover new fashion blogs, get style tips and find fashion inspiration.
				...
				<td width=49.5% style="padding:2px 40px 2px 15px; background:url('images 1/arrow-right.png') right center no-repeat;border:1px solid none;" >
					<table width=100% style="border-collapse:collapse;" >
						<td style="padding:15px">
							<img src="images 1/wms.png" />
						</td>
						<td style="padding:10px" >
							<b style="font-family:misoBold;font-size:30px">the world's most stylish</b>
							<div style="padding:5px"></div>
 ...
 -->
								We are currently in our BETA period and to celebrate our official site launch, we will be 
								hosting styling competition. Prizes totaling $3000 USD and additional prizes, 
								...
								echo "
									...
									<td width=49.5%  style=\"\" >
										...
										<td width=49.5% valign=top style=\"padding:20px 10px 20px 10px;\" >
											...
											<div style=\"padding:4px;\"></div>
											<center>
												<a href='http://fashionsponge.com'><input type=image src=\"images 1/signup-button.png\" /></a>
												<div style=\"padding:5px;\"></div>
												<b style=\"font-family:helvetica;font-size:12px;color:#797979;\">
