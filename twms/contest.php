...
.style2 {
	...
	<body>
 	...
 	<link rel="stylesheet" type="text/css" href="fs_folders/contest/contest.css" >
 	<script type="text/javascript" src='fs_folders/contest/contest.js'></script>
	...
	<div style="position:absolute;top:0;left:0;width:100%;">  
		...
		<div style="background:#1b396d;text-align:center;padding:10px;color:white; "> 
			...
			<a href="http://www.fashionsponge.com" target="_blank" >
				<image alt="FashionSponge" src="images/logo-big.png" />
			</a><br>
		...
		<div style="background:#f4f3f2;padding:10px;text-align:center;">
					...
					<table border="0" cellpadding="0" cellspacing="0" >
						 <tr> 
						 	...
						 	<td style="padding-top:3px;" > 
						 		&nbsp; <img src="images/learn.png" title="Learn About FashionSponge" />
						 	</td> 
					</table> 
				</a>
			</div>
		</div>   
		<div style="background:#1b396d url('images/back.jpg') center bottom  repeat-y;text-align:center; auto; ">  
					...
					<td width=*% valign=top   >
						<div id="slide_container">
							<table style="position:relative;" id="tab_slide" > 
								...
								<!-- awarding -->
									<td style="background-color:#f4f3f2;"  >    
										<div style="padding-left:0px; padding-top:20px; padding-right:0px; border:1px solid none; width:780px; overflow:auto" > 
											...
											<table border="1" cellpadding="0" cellspacing="0" style="margin-left:20px;height:200px;   width:740px;background-color:#f4f3f2; border:1px solid none; color:#284372; text-align:left; "  > 
												<tr> 
													 <td style="text-align:left; " >  
													 	<b id='red'>
													 		Awarding the Winners, Nominees and Most Viral 
													 	</b>
													 		<br>  
													 	<b id='red'>
															Winners
									...
									<td valign=top style="vertical-align:top"  >  
										...
										<table style="width:780px;" border="0" >
											<td style="width:560px;text-align:left;padding:20px 0 20px 20px;vertical-align:top" valign=top>
												...
												<div id="contest-details-content"   rel="scrollcontent1"  > 
											...
											<td> 
												...
												<br> 
												<a href="#"  ><img src="images/submit looks.jpg" /></a><br>
										    <br>
												<img src="images/or.jpg" /><br><br>
												<a href="#"  ><img src="images/browse entries.jpg" /></a>
											</td>
										</table> 
									</td>           	
								<!-- intro -->
											...
											<table border="0" cellpadding="0" cellspacing="0" style="margin-left:20px; ;width:740px;background-color:#f4f3f2; border:1px solid none;  ; "  > 
												<tr> 
													<td style="background-color:#f4f3f2; padding-left:20px" > 
												 	 	<div  style='text-align:left;color:#b01e23; font-size: 52px; font-family:MisoLight;background-color:#f4f3f2;width:730px;border: 1px solid none' > 
													 	 	...
													 	 	<div style='padding-bottom:10px;text-align:left;color:#284372; font-size: 14px; font-family:Helvetica;background-color:#f4f3f2; width:690px;border: 1px solid none' >   
													 	 		<span id='red' >16 chances to win.</span>  4 grand prize winners will win <span id='red' >$500 USD</span> and additional prizes. 
													 	 	</div> 
												 	 	<br>  
								...
								<!-- juges 1  -->
									...
									<td> 
										...
										<div> 
											...
											<div  style='text-align:center;color:#000; font-size: 20px; font-family:MisoLight; color:#284372;  ' >
									...
									<td style='display:none'>
										...
										<img src="images/slides/3.jpg"  class="slide_img" /> 
									</td>    
								<!-- judging  --> 
								...
								<!--  cash -->
									<td>  
										<img src="images/slides/2.jpg" class="slide_img" />
									</td>     
								<!-- sponsors -->
									<td valign=top >   
											...
											<tr>
												<td style="width:20px;" > 
													<a href="http://www.laurenmessiah.com" target="_blank" >
														<img src="images/slides/lauren.png" style="border:1px solid none;float:left; height:347px; margin-left:-3px; margin-top:2px;"  /> 
													</a>
												</td>
															...
															<tr> 
																<td>   
																	<div  style="position:relative; padding-top:20px; " >
																		<a href="http://www.facebook.com/SchoolofStyle" target="_"><img src="images/fb-social-icons.png" /></a> &nbsp;&nbsp; 
																		<a href="https://twitter.com/schoolofstyle" target="_"><img src="images/tw-social-icons.png" /></a>&nbsp;&nbsp;
																		<a href="http://www.youtube.com/user/SchoolofStyleLA" target="_"><img src="images/yt-social-icons.png" /></a>
																	</div> 
																</td>
															<tr> 
																<td>   
												...
												<td style=" padding-right:30px; " >  
													<a href="http://www.lukestorey.com" target="_blank" >
														<img src="images/slides/luke.png" style="position:absolute; border:1px solid none; float:left;height:348px;  z-index:99; margin-left:-100px; margin-top:15px; "   />  
													</a>
												</td>
										</table>  
									</td>     
							...
							<span style="position:relative;top:-90px;left:10px;">
								<input style="display:none" type='image' alt="Play/Pause" src="images/btn_pause.png" title="Pause" id="PlayPause" onClick="PlayPause()" />
							</span>
						</div>
					</td>
			...
			<div style="width:780px;margin:0 auto;text-align:center;">
				...
				<div style="margin:0 auto;">
					...
					<div style="padding:10px;color:white;background:url('images/back-trans.png');text-align:left; border:1px solid none; ">
						...
						<span class="nav_text" 	 id="nav_text_1" onClick="navigate_text(1);" title="Introduction" style="color:white" >INTRO</span>&nbsp;&nbsp; / &nbsp;&nbsp;
						<span class="nav_text" 	 id="nav_text_2" onClick="navigate_text(2)" title="Prizes" >CONTEST DETAILS</span> &nbsp;&nbsp; / &nbsp;&nbsp;
						<span class="nav_text" 	 id="nav_text_3" onClick="navigate_text(3)" title="Judges" >JUDGING</span>&nbsp;&nbsp; / &nbsp;&nbsp;
						<span class="nav_text" 	 id="nav_text_4" onClick="navigate_text(4)" title="Judges" >AWARDING</span>&nbsp;&nbsp; / &nbsp;&nbsp;
						<span class="nav_text"   id="nav_text_5" onClick="navigate_text(5)" title="Sponsors" >PRIZES</span> &nbsp;&nbsp; / &nbsp;&nbsp;
					...
					<div>  
						<?php 
							echo " 
								<a href='http://fashionsponge.com' target='_blank' > 
										<img src='$mc->genImgs_twms/sign up button.png'   style='width:780px;'  /> 
								</a> 
							"; 
						?> 
					</div>
					...
					<br>
						...
						<table width=70%  border="0" > 
							<td valign=top style="padding:0px 25px 5px 0;border-right:1px solid #5f7293;"><a style="text-decoration:none;" href='http://www.fashionsponge.com' target="_" ><img src="images/logo-small-x.png" width=150 /></a></td>
							<td valign=top style="padding:10px 25px 5px 25px;border-right:1px solid #5f7293;">
								 
								<a style="color:#d20e0e;font-family:helveticabold;font-size:12px" target="_" href='#'  >ABOUT</a>
							</td>
							<td valign=top style="padding:10px 25px 5px 25px;border-right:1px solid #5f7293;"> 
								<a style="color:#d20e0e;font-family:helveticabold;font-size:12px" target="_" href='http://www.djddw.com/'  >BLOG</a>
							</td>
