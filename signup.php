        ...
        <body itemscope itemtype="http://schema.org/Product">
            ...
            <div id="signup-container-responsive" class="container" style="margin: 0px auto"  >
                ...
                <div id="body-content" >
                    ...
                    <img style="width:97.6%; margin: 0px auto;" src="http://fashionsponge.com/fs_folders/images/signup/devices.jpg" class="img-responsive" alt="Responsive view in laptop, tablet and mobile">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3" id="col1" >
                                <div id="container" class="exposure-container"  >
                                    <img src="http://fashionsponge.com/fs_folders/images/genImg/signup-exposure-icon-red.png" style="height:70px">
                            ...
                            <div class="col-md-3" id="col2">
                                <div id="container" class="discover-container"  >
                                    <img src="http://fashionsponge.com/fs_folders/images/genImg/signup-discover-icon-red.png" style="height:70px">
                                    <div id="private-signup-title-2" class="fs-text-blue" style="margin-top:10px; text-align:center;border:1px solid none;  ">
                                        DISCOVER
                                    </div>
                                    <div  id="desc" class="fs-text-blue" style="margin:auto;  margin-top:20px;  width:90%;  border:1px solid none;  ">
                                        <p> Discovering fashionable people, looks and things couldn't be easier.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3" id="col3">
                                <div id="container" class="inspiration-container" >
                                    <img src="http://fashionsponge.com/fs_folders/images/genImg/signup-learn-icon-red.png" style="height:70px">
                                    <div id="private-signup-title-2" class="fs-text-blue" style="margin-top:10px; text-align:center;border:1px solid none; ">
                                        INSPIRATION
                                    </div>
                                    <div id="desc" class="fs-text-blue" style=" margin:auto; margin-top:20px;  width:90%;  border:1px solid none;   ">
                                        <!-- Be inspired by some of the best content creators and most stylish people on the web.   -->
                                        <p>  Be inspired by some of the most stylish people on the web.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3" id="col4">
                                <div id="container" class="inspiration-container" >
                                    <img src="http://fashionsponge.com/fs_folders/images/genImg/sigmup-feedback-icon-red.png" style="height:70px">
                                    <div id="private-signup-title-2" class="fs-text-blue" style="margin-top:10px; text-align:center;border:1px solid none; ">
                                        FEEDBACK
                                    </div>
                                    <div id="desc" class="fs-text-blue" style=" margin:auto;  margin-top:20px;  width:90%; border:1px solid none;   ">
