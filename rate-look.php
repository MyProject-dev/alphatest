	 					...
	 					<table border="0" id='bct1' style="width:910px !important;" >   
							...
							<tr>
							      ...
							      <div> 
							        	...
							        	<?php 
							        		$mostLike = $look->mostLike(); 
							        		$featuredImg = "fs_folders/images/uploads/posted looks/lookdetails/$mostLike.jpg"; 
							        		if(!file_exists($featuredImg)) { 
							        			$featuredImg = 'fs_folders/images/modal/article/look-featured-image.png';
