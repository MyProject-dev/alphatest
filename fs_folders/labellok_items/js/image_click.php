        ...
        reader.onload = function (_file) {
            ...
            image.onload = function () {
                ...
                if (w >= 300 && h >= 300) {
                    ...
                    alert('Min look size required 300px by 300px and your current upload look size is ' + w + ' by ' + h)
...
function show_hide_dropdown(id) {
    ...
    //alert('display = ' + display + ' value = '+ value);
    // show or hide the dropdown
//    alert('#table_container_' + num);
