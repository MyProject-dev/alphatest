...
//                                                        $response = $database->getResult();
							    ...
							    $tlooks = $look1->totalUploaded1($mc->mno);   
 								 //echo "Updating the total look here $tlooks";
 								if(mysql_query( "UPDATE fs_members SET tlooks = $tlooks  WHERE mno = $mc->mno " )){
 										echo "User total article $tlooks is updated <br>";
 								} else {
 									...
 									case 'design':   ?> 
 												<center> 
			 			 							<div id="flag-modal-container" > 
			 			 								<table border="0" cellpadding="0" cellspacing="0" >	
			 			 									<tr> 
			 			 										<td   > <div style="padding-bottom:5px;" ><span>Hiding this post remove it your feed.</span> </div></td>
			 			 									<tr> 
			 			 										<td>   
			 			 										</td>
			 			 									<tr> 
			 			 										<td class="hide" > <textarea rows="4" cols="20" placeholder='Add your comment here. . .' id="flag-comment" ></textarea></td> 
			 			 									<tr>
			 			 										<td style="padding-top:5px;" >  
			 			 											<table style="width:auto;margin-left:-3px;" border="0" cellpadding="0" cellspacing="0"  >
			 			 												<tr> 
			 			 													<td> <input class="popup-button-submit" type="button" value="cancel" onclick="fs_popup( 'close' )" /> </td>
			 			 													...
			 			 													<td> 
			 			 														<input class="popup-button-submit" type="button" value="Ok" onclick="send_flag( 'hide post' , '<?php echo $table_id ?>', '<?php echo $table_name ?>' , '', 'flag_post_hide_save')"  >     
			 			 													</td>
			 			 											</table>
			 			 										</td>
			 			 								</table> 
			 			 						...
			 			 						<center> 
			 			 							<div id="flag-modal-container" > 
			 			 								<table border="0" cellpadding="0" cellspacing="0" >	
				 			 										...
				 			 										<table style="margin-left:-5px;" border="0" cellpadding="0" cellspacing="0" id="flag-option-table"  >
				 			 											<?php 
				 			 												for ($i=0; $i < count($options) ; $i++):
					 			 												...
					 			 												echo "  
							 			 											<tr> 
							 			 												<td> <input type='checkbox' name='option-$i' id='option-$i' value='$op' onclick=\"flag_option_click('$op', 'option-$i')\" /><span>$op</span></td>  
						 			 											";
				 			 											endfor;  
				 			 											?> 
				 			 										</table>
			 			 									...
			 			 									<tr> 
			 			 										<td> <textarea style="display:none"  rows="4" cols="20" placeholder='Add your comment here. . .' id="flag-comment"  ></textarea></td> 
			 			 									<tr>
			 			 										<td style="padding-top:5px;" >  
			 			 											<table style="width:auto;margin-left:-3px;" border="0" cellpadding="0" cellspacing="0"  >
			 			 												<tr> 
			 			 													...
			 			 													<!-- <td> <input type="button" value="submit"  />  </td> -->
			 			 													 <td><input class="popup-button-submit" type="button" value="Ok" onclick="send_flag( 'flag post' , '<?php echo $table_id ?>', '<?php echo $table_name ?>' , '', 'flag_post_save')"  >   </td> 
			 			 											</table> 
			 			 										</td>
			 			 								</table> 
			 			 							</div>
			 			  	...
			 			  	case 'insert':
									...
									if ( $method == 'edit'):
									    ...
									    # update article info 
											...
											$response = mysql_query(" UPDATE fs_postedarticles SET title = '$title' , description = '$desc' , keyword = '$keyword' , category = '$category' , topic = '$topic', active = 1, tags = '$tags' WHERE artno = $table_id "); 
										...
										# add category 
			 						    ...
			 						    #update total article   



			 								
			 								$tarticle = $article1->totalUploaded1($mc->mno);   
			 								//echo "Updating the tarcitcle here $tarticle";
			 								if(mysql_query( "UPDATE fs_members SET tarticle = $tarticle  WHERE mno = $mc->mno " )){
			 										echo "User total article $tarticle is updated <br>";
			 								} else {
			 										echo "failed to update the total article of the poster <br>";
			 								}
			 								//echo " end script here t article $tarticle";
