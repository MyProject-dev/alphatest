...
class Email
{
            ...
            <table class='body-wrap'>
                <tbody><tr>
                    ...
                    <td class='container' bgcolor='#FFFFFF'>
                        ...
                        <table>
                            <tbody><tr>
                                <td class='container-1' style='border:1px solid #f4f3f2;padding:10px;color:#146097;font-size: 13px;' >
                                          <div class='header-1'>
                                          <center>
                            ...
                            <center>
                                <h3 class='text-1' style='color:#146097;font-size:23px; border-bottom: 1px solid #f4f3f2;border-top: 1px solid #f4f3f2;padding: 15px 0px 15px 0px;line-height: 1;font-weight: bold;'> FINALLY, SOMETHING COOL FOR BLOGGERS. </h3>
                            </center>
                            <div class='lead'>
                                " . $content['invitation'] . "
                            </div>
                            ...
                            <div class='lead'>
                                <p>
                                     <span style='color:#146097;'>
                                        Mauricio | Founder &amp; Creative Director  <br>
                                        <a style='color:#696969;'>Mauricio@fashionsponge.com</a>
                                    </span>
                                 </p>
                            </div>
                            <div style='border-top:1px solid #f4f3f2;border-bottom:1px solid #f4f3f2; padding-top: 15px; padding-bottom: 15px;font-size: 23px;font-family:arial; color:#146097;text-align: center;line-height: 1;'>
                            ...
                            <!-- footer  !-->
                                <div style='border-top:1px solid #f4f3f2;border-bottom:1px solid #f4f3f2; padding-top: 15px; padding-bottom:10px;font-size: 23px; &nbsp;'>
                                    ...
                                    <span style='font-family:arial; color:#c51d20;'>
                                      ...
                                      <b style='font-size:12px;color:#146097;font-family: arial;'>
                                ...
                                <tbody><tr>
                                    <td class='container-1' style='border:1px solid #f4f3f2;padding:10px;color:#146097;font-size: 13px;' >
                                        ...
                                        <div class='lead'>
                                            ...
                                            <p style='color:#c22825;font-weight: bold' >
                                                Quick Question:
                                            </p>
                                            <p>
                                            ...
                                            <p>
                                                If so, Fashion Sponge just maybe the answer to your dilemma. <br> <a href='$link_signup' style='color:#c22825;' > Sign up now. Space is limited.</a>
                                            </p>
                                            <p>
                                                 <span style='color:#146097;'>
                                ...
                                <tbody><tr>
                                    <td class='container-1' style='border:1px solid #f4f3f2;padding:10px;color:#146097;font-size: 13px;' >
                                        ...
                                        <div class='lead'>
                                            ...
                                            <p>
                                                If so, Fashion Sponge just maybe the answer to your dilemma. <br> <a href='#' style='color:#c22825;' >Don't be fashionably late. Sign up now.</a>
                                            </p>
                                            <p>
                                                 <span style='color:#146097;'>
                                                    <b>Mauricio | Founder &amp; Creative Director</b> <br>
    ...
    public static function sendInviteEmail3($from, $to, $subject, $qid, $tEmailSent=0, $invited_fn=null)
    {
        ...
        {
            case 0:
                    $footer_info = "This invitation was sent to <span style='color:#4fb240'>$to</span>. To ensure you get notice of your invite, you will receive <b>2</b> additional emails. If you don't want to receive anymore emails in the future, <a style='color:#4fb240; text-decoration: none;' href='$link_remove' target='_blank'> click here </a> to remove your email.";
                break;
            case 1:
                    $footer_info = "This invitation was sent to <span style='color:#4fb240'>$to</span>. To ensure you get notice of your invite, you will receive <b>1</b> additional emails. If you don't want to receive anymore emails in the future, <a style='color:#4fb240; text-decoration: none;' href='$link_remove' target='_blank'> click here </a> to remove your email.";
                break;
            default:
                    $footer_info = "This invitation was sent to <span style='color:#4fb240'>$to</span>. If you don't want to receive anymore emails in the future, <a style='color:#4fb240; text-decoration: none;' href='$link_remove' target='_blank'> click here </a> to remove your email.";
                break;
        }
                                    ...
                                    <table>
                                        <tbody><tr>
                                            <td class='container-1' style='border:1px solid #f4f3f2;padding:10px;color:#146097;font-size: 13px;' >
                                                ...
                                                <div class='lead'> 
                                                    <p style='font-size: 1px; color:white;position:absolute;display:none' >
                                                         $openTracker
                                                    </p>
                                                    <p style='font-size: 1px; color:white;position:absolute;' > 
                                                        FINALLY, SOMETHING COOL FOR BLOGGERS.
                                                    ...
                                                    <p style='font-size: 120%'  >
                                                        Fashion Sponge is a social network where the best content creators in <b>Fashion</b>, <b>Beauty</b>, <b>Lifestyle</b> and <b>Entertainment</b> can grow their audience and readers can discover the latest people, places and things.
                                                    </p>
                                                    <p style='font-size: 120%'  >
                                                    ...
                                                    <p style='font-size: 120%'  >
                                                        Limiting memberships to content creators who create content that's high quality, compelling, inspirational, informative or entertaining, Fashion Sponge will become a go-to destination for seeing the best content by the best content creators.
                                                    </p>
                                                    <p style='color:#c22825;font-weight: bold; font-size: 120% ' >
                                                        Quick Question:
                                                    </p>
                                                    <p style='font-size: 120%'  >
                                                        <b>Are you creating high quality content that's either compelling, inspirational, informative or entertaining, that's not getting a lot of views, likes or shares?</b>
                                                    ...
                                                    <p style='font-size: 120%'  >
                                                        If so, Fashion Sponge just maybe the answer to your dilemma. <a href='$link_signup' style='color:#c22825;' >Sign up now.</a>

                                                    </p>
                                                    <p>
                                                         <span style='color:#146097; font-size: 120% '>
                                                            <b>Mauricio | Founder &amp; Creative Director</b> <br>
                                                            <a href='#' style='color: #2BA6CB;'>Mauricio@fashionsponge.com</a>
                                                        </span>
                                                    </p>
                                                ...
                                                <div style='padding-top:10px;'>
                                                    <a href='$link_signup'>
                                                        <img style='cursor:pointer; width:100%;' src='http://www.fashionsponge.com/fs_folders/images/email/version3/curious.jpg'>
                                                    </a>
                                                </div>
                                        ...
                                        <tr>
                                                <td>
                                                    <!--footer-->
                                                    <div style='background-color: #FEFEFE; padding:12px; color:#cbcdd0'>
                                                         <p style='font-size: 120%'  >
                                                            $footer_info
                                                        </p>
                                                    </div>
                    ...
                    <table class='body-wrap'>
                        <tbody><tr>
                            ...
                            <td class='container' bgcolor='#FFFFFF'>
                                ...
                                <table>
                                    <tbody><tr>
                                        <td class='container-1' style='border: 1px solid #f4f3f2; padding:10px;color:#146097;background-color: white;'>
