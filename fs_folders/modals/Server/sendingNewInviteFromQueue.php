...
$db       = (!empty($_SESSION['db']))  ?  $_SESSION['db']  : '../../../fs_folders/php_functions/Database';
$time     = (!empty($_SESSION['time']))  ?  $_SESSION['time']  : '../../../fs_folders/php_functions/Time';
$Message  = (!empty($_SESSION['Message'])) ?  $_SESSION['Message']  : '../../../fs_folders/php_functions/Message';
$Admin    = (!empty($_SESSION['Admin']))  ?  $_SESSION['Admin']  :  '../../../fs_folders/php_functions/Admin';
$Email    = (!empty($_SESSION['Email']))  ?  $_SESSION['Email']  : '../../../fs_folders/php_functions/Email';
...
$dateTime =  '';
$counter  =   1;
$sendOne  =  (!empty($_SESSION['sendTotalEmailNow'])) ? $_SESSION['sendTotalEmailNow']  :  0;
 


 
// print_r($invitedQueue->getAllInvitedInTheQueueWhoWillReceiveAnInviteEmail_() );
...
print("Total Allow Sent is  $sendOne <br>");
