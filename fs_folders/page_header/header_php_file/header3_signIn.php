		...
		*/  
  		# set up if show header of hide 
			...
			if ( $show == true ): 
				...
				switch ( $header_page ) {
					case 'profile':
						 	$header_settings_tab_profile_style = 'background-color:#225b99;color:white';
						break;
					case 'account':
						 	$header_settings_tab_account_style = 'background-color:#225b99;color:white';
						break;
					case 'home':
						 	$header_settings_tab_style = 'background-color:#225b99;';
						break;
					case 'lookdetails':
						 	$header_settings_tab_style = 'background-color:#225b99;';
						break; 
											 	...
											 	<!-- settings result container --> 
											 		...
											 		<div id="settings_result"     > 
											 			<table border="0" cellpadding="0" cellspacing="0" >
											 				...
											 				<tr> 
											 					<td onclick="settings_dropdown_tab_clicked ( '2' , 'account?at=7' )"                   ><div  style='<?php echo "$header_settings_tab_account_style"; ?>'  id='header-settings-dropdown-2'  > Account Settings </div></td>
											 				<tr>
								 			...
								 			<td id="prof_ratings"  width="200px" >
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" id="header-article-stat" >
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td id="ratigs_names"  > <a href="<?php echo "$this->identity_username-articles"; ?>" > <span> RANK </span> </a> </td>
                                                        <td id="ratigs_names"  > <a href="<?php echo "$this->identity_username-followers"; ?>" > <span> FOLLOWERS </span> </a> </td>
                                                    <tr>
                                                </table> 
                                                <table border="0" cellpadding="0" cellspacing="0" id="header-look-stat" style="display:none"  >
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td id="ratigs_names"  >  <a href="<?php echo "$this->identity_username-looks"; ?>" ><span> RANK </span> </a></td>
                                                        <td id="ratigs_names"  >  <a href="<?php echo "$this->identity_username-followers"; ?>" ><span> FOLLOWERS </span> </a></td>
                                                    <tr>
                                                </table> 
                                            </td>
