...
function modal ( action , process , type , loader , response , textfieldid , value , multivalue , method , table_id , table_name, agreementId)
{
    ...
    */ 
    ...
    if ( action == 'modal-attribute' ) {
        ...
        $('#label-look-dropdown-container, .label-look-dropdown-container-1').css('display','block'); 
        if ( multivalue == true ) {
        ...
        $('#label-look-dropdown-container, .label-look-dropdown-container-1').css('display','none');
        ...
        $('#'+response).css('display','none');
        $('.label-look-dropdown-container-1').css('display','none');
    }
}
// end modal  
// new url
...
function flag_option_click(value, id) {  
    if($('#'+id).is(":checked")) {  
        // alert(value);  
        if(value == 'Photo infringes copyrighted material.') { 
            // alert('Submit link to the original copyright material')
            $('#flag-comment').css('display','block');
            $('#flag-comment').attr('placeholder', ' Submit link to the original copyright material'); 
        } else if (value == 'Look was posted in the wrong category.') { 
            // alert('What category should this look be placed in?') 
            $('#flag-comment').css('display','block');
            $('#flag-comment').attr('placeholder', ' What category should this look be placed in?'); 
        } else {
...
function resend_email() {   
    // jquery get 
    //if success then alert email sent 
    // else email not sent please try again later. 
