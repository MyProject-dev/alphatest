<?php 
	...
	// datejoined  
		$djoined = $mc-> date_format( $uinfo[0]['datejoined'] );    
	  	...
	  	$url_facebook     = clean_url($uinfo[0]['url_facebook']);
	  	$url_twitter      = clean_url($uinfo[0]['url_twitter']);
	  	$url_pinterest    = clean_url($uinfo[0]['url_pinterest']);
	  	$url_instagram    = clean_url($uinfo[0]['url_instagram']);
      			...
      			<tbody>
	      			<tr>   
	  					<?php if(!empty($url_pinterest)) { ?>
							<td>  
								<a href="http://www.<?php echo $url_pinterest; ?>" > 
									<img 
						...
						<?php if(!empty($url_web)) {  ?>
							<td>  
								<a href="http://www.<?php echo $url_web; ?>" > 
									<img 
						...
						<?php if(!empty($url_facebook)) { ?>
							<td>  
								<a href="http://www.<?php echo $url_facebook; ?>" >
									<img 
						...
						<?php if(!empty($url_instagram)) { ?> 
							<td> 	 
								<a href="http://www.<?php echo $url_instagram; ?>" >
									<img 
						...
						<?php if(!empty($url_youtube)) { ?> 
							<td>  
								<a href="http://www.<?php echo $url_youtube; ?>" >
									<img 
						...
						<?php if(!empty($url_twitter)) { ?> 
							<td>  
								<a href="http://www.<?php echo $url_twitter; ?>" >
									<img 
