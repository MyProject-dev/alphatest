...
{ ?>
    ...
    <!--    <div style="float: right;" id="logo-beta-right" >
        img src="../../../../fs_folders/images/signup/beta.jpg"    >
        </div>-->
    <div id="signup-header-menu" style="padding: 20px;">
        <div style="float: left;" id='signup-logo' >
            <a href="\">
...
{?>
    <div id="signup-header-menu">
        <nav class="navbar navbar-inverse" role="navigation" style="border:none; background-image: none;  background-color:#146097 !important; padding:0px; margin: 0px;" >
            <div class="container">
