	...
	class myclass extends myclassCode {
		...
		public function getUserInfo($mno, $get) {
			 ...
			 //if($get == 'blogurl') { 
			 	   ...
			 	   //$blogName = str_replace('http://wwww.', '', $uinfo[0][$get]);
			 	  // $blogName = str_replace('http://wwww.', '', $uinfo[0][$get]);
			 	//   $blogName = str_replace('http://wwww.', '', $uinfo[0][$get]);
			 	//   $blogName = str_replace('http://wwww.', 'wwww.', $uinfo[0][$get]);
			...
			<?php switch ( $header['type'] ) {
				...
				default: ?> 
							...
							<!-- local css and js --> 
                                ...
                                <script type="text/javascript" src='fs_folders/js/look.js'></script>
                                <script type="text/javascript" src='fs_folders/js/article.js'></script>
