...
<!--			                  		<td id="invited-people-email" > --><?php //$remainingDays = $interval_time_send-$days; $dayname='Days'; if ($remainingDays==1) {  $dayname="<span style='color:red'>Day</span>"; }  echo $remainingDays." $dayname Remaining";  ?><!-- </td> -->
 ...
 --> 
					                            	<td class="padding-left-20" style="padding: 0px;" > 
			...
			#NEW MODALS     
				...
				public function new_modals_header( $mno , $action ,  $profilepath=null , $type=null ) {   
      			...
      			public function modal_version1_look ( $_table_id , $lookpath=null , $profilepath=null , $headersyle=null , $commentstyle=null  , $page=null  ) {  
					...
					$look_attr['pltvotes']        = $li['pltvotes'];    
											...
											<!-- description -->  
			      							...
			      							<?php else: ?>  
			      								...
			      								<?php  
				      							 ...
				      							 $pltvotes    = select_v3('postedlooks', 'sum(pltvotes) as total', "mno = " . $look_attr['owner'] . " and style = '$style'")[0]['total'];  
      			...
      			public function modal_version1_article ( $_table_id , $lookpath=null , $profilepath=null , $headersyle=null , $commentstyle=null  , $page=null, $status=null ) {  
				    ...
				    # get postarticle info 
						...
						$look_attr['pltvotes']		  =  $response[0]['pltvotes'];  
											...
											<!-- dripped message  -->
		  									...
		  									<!-- category message  -->
		  										...
		  										<?php if ( !empty($look_attr['topic']) ): ?>  
		  											<a href="article?category=<?php  echo strtolower($look_attr['category']);  ?>&&topic=<?php echo strtolower($look_attr['topic']) ?>">
			  											<div class="modal-footer-category" >
											...
											<!-- blue rectangle   -->	
				      						...
				      						<?php else: ?>     
				      							<?php   
					      							...
					      							$tfollowers  = $memFsInfo['tfollowers']; 
					      							$tarticle    = select_v3('fs_postedarticles', 'count(artno) as tarticle', " category =  '$category' and mno =  " . $look_attr['owner'] )[0]['tarticle'];   // $memFsInfo ['tarticle'];   // get the total article that member posted in the specific category  
	   												$pltvotes    = select_v3('fs_postedarticles', 'sum(pltvotes) as total', "mno = " . $look_attr['owner'] . " and category = '$category'")[0]['total'];  
												...
												<!-- like blue --> 
													...
													<!-- HIDE this container now this is to show the total like in the article and seems not correct so hide this -->
			  										<div id="new-look-modals-stat-container-2" class='hide'> 
													  	<table cellspacing="0" cellpadding="0"> 
													  		<tbody>
													  			<tr> 
						      										...
						      										<!-- new member desc and header content -->
												 						...
												 						<div id="mouserOver_content" class="member-modal-content-container">   
																		  	...
																		  	<div class="member-post-status">  
																		  		<table border="0" >
																		  			<tr>
																		  				...
																		  				<td> <text>Looks:</text>    <text>Likes</text> </td> 
																		  				<td> <div style="float:right"> <stat><?php echo $trating_look; ?></stat> |  </div>  </td>   

																		  			    <td   style="padding-left: 5px;" >   <text>Articles:</text> <text>Likes</text></td> 
																		  			    <td>  <div style="float:right"> <stat><?php echo $trating_article; ?></stat></div>   </td> <tr> 

																		  				<td> <text>Rank:</text> <text>Looks</text> </td>  
																		  				<td> <div style="float:right"> <stat>0</stat> | </div>  </td> 

																		  			    <td   style="padding-left: 5px;"  > <text>Articles</text> </td> 
																		  			    <td> <div style="float:right"> <stat>0</stat> </div></td>  <tr>
																		  		</table>
																		    ...
																		    <div class="member-description">  
																				<?php echo $this->string_limit($aboutme, 250, 'member', $username1); ?>
																		      </div>
					  											...
					  											<ul id="new-look-modals-footer-icons">	
																	...
																	<li>  
																		<div title="looks (<?php echo $tlooks; ?>)" > 
																			...
																			<a href="<?php echo $username1 ?>-looks ">
																				<img 
																	...
																	<li>  
																		<div title="articles (<?php echo $tarticle; ?>) " >
																			...
																			<a href="<?php echo $username1 ?>-articles ">
																				<img 
					 		...
					 		<?php
					 		 ...
					 		 ?>
						 		...
						 		<?php if ( $table_name == 'postedlooks' ): ?>
						 			...
						 			<a href='postalook?id=<?php echo $table_id; ?>&method=edit'>
						 		<?php else: ?>
						 			<!-- <a href="#"  onclick="fs_popup( 'postarticle' , 'postarticle' , 'design' , 'edit' , '<?php echo $table_id; ?>' , '<?php echo $table_name; ?>' ) " >   -->
						 			<a href="postarticle?id=<?php echo $table_id; ?>&method=edit">  
						 		<?php endif; ?> 
										 		...
										 		<li>
										 			<table border="0" cellpadding="3" cellspacing="0" style="margin-top:8px; margin-left:10px;" >
										 				<tr>  
										 					...
										 					<td> <div id="look-details-profile-look-owner-header-text"   onclick="lookdetails_delete_look( '<?php echo "$table_id" ?>' , '<?php echo "$table_id_1" ?>' , '<?php echo $table_name; ?>' )" >  DELETE 1 </div></td>
										 			</table>
										 		</li>   
									 		<?php 
									 			// echo "<li> ";
				...
				*/ 
				public function fs_postedarticles( $array ){ 
						...
						# initialized
							...
							$tags        = ( !empty($array['tags']) )       ? $array['tags']       : null ; 
									    	...
									    	<?php elseif ( $table_name == 'postedlooks' ): ?> 
											        	...
											        	<li style="border-bottom:1px solid #e2e2df" >
											          		<!-- <div id="new-look-modals-share-icon-1" class='share_look_modals<?php echo $id; ?>'  onclick="fs_popup( 'postarticle' , 'modal-attribute' , 'look-modal-design' , 'edit' , '<?php echo $table_id; ?>' , 'postedlooks' ) " >  -->
											          			<!-- EDIT -->
											          		<!-- </div> -->
											          		<a href="<?php echo $posting_link ; ?>&method=edit"  >
												          		<div id="new-look-modals-share-icon-1" class='share_look_modals<?php echo $id; ?>'  >
												          			EDIT
												          		</div>
											          		</a>
											          	...
											          	<li>
											          		<div   id="new-look-modals-share-icon-1" class='share_look_modals<?php echo $id; ?>'  onclick="destroy_look('<?php echo $table_id; ?>')" >   
											          			DELETE
															</div> 
											          	</li>   
										    <?php elseif ( $table_name == 'fs_postedarticles' ): ?>
										    	...
										    	<!-- if owner of the post --> 
										        	<li style="border-bottom:1px solid #e2e2df" >
										          	...
										          	<li>
										          		<div   id="new-look-modals-share-icon-1" class='share_look_modals<?php echo $id; ?>' onclick="destroy_article('<?php echo $table_id; ?>')"  >    
										          			DELETE
														</div> 
										          	</li>     
									   		<?php endif; ?>
