	 					...
	 					<table border="0" id='bct1' style="width:910px !important;" >   
							...
							<tr>
							  	<td id="article-page-featured-image-td"> 
							      	<div> 
                                        ...
                                        <?php// $mostLike = $article->mostLike(); ?>
                                        <!-- <img src="fs_folders/images/uploads/posted articles/home/<?php echo $mostLike; ?>.jpg"> --> 
										<!-- <img src="fs_folders/images/article/article-featured-image.png">--> 
                                        <!-- <div class="rate-featured-image" style="background-image: url('fs_folders/images/uploads/posted articles/detail/<?php echo $mostLike; ?>.jpg');"> 
                                        </div> -->


                                    	<?php 
							        		$mostLike = $article->mostLike(); 
							        		$featuredImg = "fs_folders/images/uploads/posted articles/detail/$mostLike.jpg"; 
							        		if(!file_exists($featuredImg)) { 
							        			$featuredImg = 'fs_folders/images/article/article-featured-image.png';
							        			$featuredStyle = ' background-position-y:0px; ';
							        		}   
							        	?>
										<div class="rate-featured-image" style="background-image: url('<?php echo $featuredImg; ?>'); <?php echo "$featuredStyle" ?> "> 
                                        </div>
                            ...
                            <td>
                                <div id="rate-look-dropdown" >
                                    <center>
                                        <table border="0" cellpadding="0" cellspacing="0" style="padding-bottom: 14px;" >
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <select  id="rate-look-style" onchange="rate_look_retrieve_nextprev_and_look_modals( )" >
                                                        ...
                                                        <option <?php echo ($category == 'beauty') ? 'selected' : ''; ?> >Beauty</option>
                                                        <option <?php echo ($category == 'lifestyle') ? 'selected' : ''; ?> >Lifestyle</option>
                                                    	...
                                                    	<?php 
                                                    		if(!empty($topic)) {  
                                                    			foreach ($topic_array as $key => $value) { ?> 
                                                    				<option <?php echo ($value == $topic) ? 'selected' : ''; ?> ><?php echo $value; ?></option>  
                                                    				<?php 
                                                    			}
